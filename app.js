...
console.log(__dirname+"/images/images/JPIZZLE TECH.PNG");
*/
app.get('/jpizzletech', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app develpoed by MyLandmarkTech</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to  Jpizzle Tech. Please Contact +6475718411 for more information or send an email to johnpaule691@gmail.com <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
		...
		'technology': 'DevOps',
		'contact' : '+16475718411',
		'email': 'johnpaule691@gmail.com.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://jpizzletech.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/jpizzletech");
      })
